...
import cn.treedeep.link.protocol.v1.device.protocol.model.command.CmdDeviceBind;
import cn.treedeep.link.protocol.v1.device.protocol.model.command.CmdDeviceUnBind;
import cn.treedeep.link.protocol.v1.device.protocol.model.command.CmdStartRecording;
import cn.treedeep.link.protocol.v1.device.protocol.model.command.CmdStopRecording;
import cn.treedeep.link.protocol.v1.device.protocol.model.report.ReportDeviceBindResponse;
import cn.treedeep.link.protocol.v1.device.protocol.model.report.ReportHeartbeatPacket;
import cn.treedeep.link.protocol.v1.device.protocol.model.report.ReportStartRecordingResponse;
import cn.treedeep.link.protocol.v1.device.protocol.model.report.ReportStopRecordingResponse;
        ...
        switch (frame.getCommand()) {
            ...
            default:
                log.warn("设备：设备【{}】收到未支持的命令类型: 0x{}", 
                    ...
                    Integer.toHexString(frame.getCommand() & 0xFF).toUpperCase());
        }
    }
